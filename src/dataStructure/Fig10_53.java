...
public class Fig10_53 {
	...
	/**
	 * Compute all-shortest paths. a[ ][ ] contains the adjacency matrix with a[
	 * i ][ i ] presumed to be zero. d[ ] contains the values of the shortest
	 * path. Vertices are numbered starting at 0; all arrays have equal
	 * dimension. A negative cycle exists if d[ i ][ i ] is set to a negative
