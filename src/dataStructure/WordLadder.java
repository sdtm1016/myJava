...
public class WordLadder {
	...
	public static Map<String, List<String>> computeAdjacentWordsSlow(
	...
	public static Map<String, List<String>> computeAdjacentWordsMedium(
			List<String> theWords) {
		Map<String, List<String>> adjWords = new HashMap<>();
					...
					if (wordClique.size() >= 2)
						for (String s1 : wordClique)
							for (String s2 : wordClique)
								if (s1 != s2) // must be same string; equals not
												// needed
	...
	// tie.
	public static List<String> findMostChangeable(
	...
	public static void printHighChangeables(
			Map<String, List<String>> adjacentWords, int minWords) {
		for (Map.Entry<String, List<String>> entry : adjacentWords.entrySet()) {
	...
	// for
	// each word pair.
	public static List<String> findChain(List<String> words, String first,
			String second) {
